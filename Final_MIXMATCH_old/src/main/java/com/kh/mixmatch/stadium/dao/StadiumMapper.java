...
public interface StadiumMapper {
	...
	// 경기장 등록
	@Insert("INSERT INTO g_stadium(s_seq,s_name,s_address1,s_address2,s_logo_name,s_logo,s_regdate) VALUES(g_stadium_seq.nextval,#{s_name},#{s_address1},#{s_address2},#{s_logo_name,jdbcType=VARCHAR},#{s_logo,jdbcType=BLOB},sysdate)")
