...
<div class="page-main-style">
	...
	<ul>
		...
		<li>첨부파일 : <a href="file.do?seq=${board.seq}">${board.filename}</a></li>
		</c:if>
	</ul>
	<hr size="1" width="100%">
	...
	<div class="align-center">
		<img src="imageView.do?seq=${board.seq}" style="max-width:500px">
	</div>
	</c:if>
	<p>
		${board.content}
	...
	<div class="align-right">
		...
		<input type="button" value="수정"
		    onclick="location.href='Gupdate.do?seq=${board.seq}'">
		<input type="button" value="삭제"
		    onclick="location.href='Gdelete.do?seq=${board.seq}'">
		</c:if>
		<input type="button" value="목록"
		    onclick="location.href='Gboard.do'">    
	</div>
	<div id="reply_div">
		<span class="reply-title">댓글 달기</span>
		<form id="re_form">
			<input type="hidden" name="seq"
			                 value="${board.seq}" id="seq">
