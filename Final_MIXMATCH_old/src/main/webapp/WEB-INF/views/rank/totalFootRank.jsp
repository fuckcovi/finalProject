	...
	<div class="teamList">
		<table>
			<tr>
				...
				<th>팀명</th>
				<th>연고지</th>
				<th><a href='totalFootRank.do?order=t_win'>승리</a></th>
				<th><a href='totalFootRank.do?order=t_draw'>무승부</a></th>
				<th><a href='totalFootRank.do?order=t_lose'>패배</a></th>
			</tr>
		<c:if test="${count>=0 }">
