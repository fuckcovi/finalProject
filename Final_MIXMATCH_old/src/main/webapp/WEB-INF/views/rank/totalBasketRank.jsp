...
<div class="page-main-style">
	...
	<table  class="ranking">
			<tr>
				...
				<th>팀명</th>
				<th>연고지</th>
				<th><a href='totalBasketRank.do?order=t_win'>승리</a></th>
		...
		<c:forEach var="list" items="${list}">
			<tr>
				<td><c:if test="${list.status eq 1}"><img src="${pageContext.request.contextPath}/resources/images/goldmedal.png" width="20"></c:if>
					...
					<c:if test="${list.status ne 1 && list.status ne 2 && list.status ne 3}">${list.status}</c:if></td>
				<td>
