...
<div class="page-main-style">
	...
	<div class="memList">
		...
		<c:forEach var="list" items="${listMem}" varStatus="status">
			<tr>
				<td>
					<c:if test="${list.recordstatus eq 1}"><img src="${pageContext.request.contextPath}/resources/images/goldmedal.png" width="20"></c:if>
					...
					<c:if test="${list.recordstatus ne 1 && list.recordstatus ne 2 && list.recordstatus ne 3}">${list.recordstatus}</c:if>
				</td>
				<td>
